...
# matrixes
translate = glm.translate(glm.mat4(), glm.vec3(0, -40, 0))
rotate = glm.rotate(glm.mat4(), 1, glm.vec3(0, 1, 0))
scale = glm.scale(glm.mat4(), glm.vec3(100,100, 100))
...
scene = pyassimp.load('./spiderman-scene.obj')
...
def glize(node):
    ...
    for mesh in node.meshes:
        ...
        texture_surface = pygame.image.load('./spiderman.dff.png')
